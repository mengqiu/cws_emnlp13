...
\end{tabular} 
\caption{Results on SIGHAN 2005 datasets. {R$_{\mathrm{oov}}$}  denotes \textsc{oov} recall, and C$_{\mathrm{onst}}$ denotes segmentation consistency. Best number in each column is highlighted in bold.
